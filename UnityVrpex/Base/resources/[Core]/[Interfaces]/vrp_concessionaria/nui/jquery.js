		...
		consultCarros.forEach((key,value) => {
			$('.overflow-cars').prepend(`
				...
				<div class="item-cars" onclick="vendercarro(this)" data-k="${key.k}">
					<img class="imagem-carro" src="http://localhost:80/FiveMUnity/cidade/carros/${key.k}.png" onerror="if (this.src != 'https://media.discordapp.net/attachments/623619036462448683/1092963441154723921/160895.png') this.src = 'https://media.discordapp.net/attachments/623619036462448683/1092963441154723921/160895.png';" alt="">
...
function verCarro(data){
	$(".disposi-carro").attr(`src`,"http://localhost:80/FiveMUnity/cidade/carros/" + data.dataset.k + ".png");
