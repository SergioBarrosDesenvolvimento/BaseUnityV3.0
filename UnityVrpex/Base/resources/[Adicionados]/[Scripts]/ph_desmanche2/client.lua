...
-----------------------------------------------------------------------------------------------------------------------------------------
local locais = { 
	 { ['x'] = 1535.63, ['y'] = 3547.81, ['z'] = 36.96, ['perm'] = "admin.permissao" }, -- 1535.15, 3547.06, 36.28
	...
	while true do
		...
		if roubando then
			...
			elseif segundos > 19 and segundos < 33 then
				sleep = 4
				Citizen.Wait(2000)
				TriggerEvent("Notify","sucesso","Sucesso","Abrindo a Porta da Frente Direita.", 10000)
				SetVehicleDoorOpen(veh,0,0,0)
				Citizen.Wait(2000)
				TriggerEvent("Notify","sucesso","Sucesso","Abrindo a Porta da Frente Esquerda.", 10000)	
				SetVehicleDoorOpen(veh,1,0,0)
				Citizen.Wait(2000)
				TriggerEvent("Notify","sucesso","Sucesso","Abrindo a Porta da Traseira Direita.", 10000)	
				SetVehicleDoorOpen(veh,2,0,0)
				Citizen.Wait(2000)
				TriggerEvent("Notify","sucesso","Sucesso","Abrindo a Porta da Traseira Esquerda.", 10000)	
				SetVehicleDoorOpen(veh,3,0,0)
				Citizen.Wait(2000)
				TriggerEvent("Notify","sucesso","Sucesso","Abrindo o Capo.", 10000)	
				SetVehicleDoorOpen(veh,4,0,0)
				Citizen.Wait(2000)
				TriggerEvent("Notify","sucesso","Sucesso","Abrindo o o Porta Mala.", 10000)	
			...
			elseif segundos <= 16 and segundos >= 4 then
				...
				Citizen.Wait(2000)
				TriggerEvent("Notify","sucesso","Importante","Veiculo desmontado.", 10000)
				TriggerEvent("Notify","importante","Importante","Dinheiro recebido.", 10000)
			end
		end
		Citizen.Wait(sleep)
	end
