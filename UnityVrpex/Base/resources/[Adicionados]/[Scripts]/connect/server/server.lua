		...
		embeds = {
			{
				...
				["fields"]= {
					...
					{
						["name"]= "> 🎮 Connect",
						["value"]= ' \n ['..fivem..'](https://cfx.re/join/djq7ly)', --Emoji clicável que abre o link
						["inline"]= true
					},
					{
						["name"]= "> 🛒 Loja",
						["value"]= '\n ['..emoji..'](https://discord.com/)',
						["inline"]= true
					},
					{
						["name"]= "> 📺 Preview",
						["value"]= '\n ['..tiktok..'](https://youtu.be/)',
						["inline"]= true
					},
				},
				["image"] = {
					["url"] = "",    ---- LINK DO BANNER QUE APARECERÁ EM BAIXO IGUAL NA FOTO DO DISCORD
				},
			}
		}
	})
