comandos = {
    ...
    policiaConsultarCnh = { cmd = "vcnh", perms = { "policia.permissao", "admin.perm" } },
    policiaRemoverCnh = { cmd = "rcnh", perms = { "policia.permissao", "admin.perm" } },
    gravarRota = { cmd = "zgc", perms = { "admin.perm" } },
    colocarCones = { cmd = "zcc", perms = { "admin.perm" } },
}

blip_provas = {
    cds = { 215.65,-1398.47,30.59 },
    item = "laudoteoricocnh",
    animation = {
        fazerAnimacao = true,
        cdsObj = { 215.65,-1398.47,30.59, 130.57 },
        cdsPed = { 207.45 + 0.22, -1390.64 + 0.22, 30.57, 136.32 }
    },
...
config = {
    ["A"] = { 
        vehicle = "vader",
        rota = rotas[2],
        spawnLoc = { 215.19, -1381.05, 30.07, 265.74 },
        maxErros = 3,
    ...
    ["C"] = {  
        vehicle = "airbus",
        rota = rotas[1],
        spawnLoc = { 217.40, -1381.13, 30.90, 269.82 },
        maxErros = 3,
        instrutor = { existe = true, model = "ig_mp_agent14" },
        valor = 5000,
    ...
    ["D"] = {  
        vehicle = "docktug",
        rota = rotas[1],
        spawnLoc = { 218.88, -1381.34, 30.78, 269.82 },
        maxErros = 3,
        instrutor = { existe = true, model = "ig_mp_agent14" },
        valor = 5000,
